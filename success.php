  ...
  <meta http-equiv="refresh" content="0.2; url='tg://resolve?domain=Best_Recruitmentt_Bot'" />
 <script>
  ...
  <div class="header">
    <img src="img/LogoBig_1x.png" alt="">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          <img class="avatar" src="img/TG HR.png">
          <!-- Заголовок канала -->
          <h1 class="jumbotron-heading">German VISA HRRecruitment</h1>
          <!-- Описание, укажите здесь то, что замотивирует человека подписаться -->
          <p style="display:block" class="lead text-muted">Нажмите на Открыть в Telegram, что бы начать чат с нами. В Telegram нажмите Start.</p>
          <p>
            <a href="success.php" class="btn btn-primary my-2" onclick="fbq('track', 'Lead');">
              Открыть в Telegram и нажать Start
            </a>
